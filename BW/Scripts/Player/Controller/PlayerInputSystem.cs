    ...
    private IController SetInputState(InputState inputState)
    {
        ...
        switch (inputState)
        {
            case InputState.Keyboard:
                Instantiate(GameManager.instance.KeyboardControllerPrefab).TryGetComponent<IController>(out controller);
                break;
            case InputState.Joystick:
                Instantiate(GameManager.instance.JoystickControllerPrefab).TryGetComponent<IController>(out controller);
                break;
