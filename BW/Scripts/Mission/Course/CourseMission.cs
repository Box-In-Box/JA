...
public class CourseMission : MissionObserver
{
    ...
    public override void Selected(int missionId)
    {
        if (MissionData.mission_id == missionId)
        {
            ...
            Button.onClick.RemoveAllListeners();
            Button.onClick.AddListener(() => MissionManager.instance.CourseMissionManager.SetNormalMission(this));
            Button.interactable = true;
        }
    }
    /// <summary>
    ...
    public override void Completed(int missionId)
    {
        if (MissionData.mission_id == missionId)
        {
            ...
            Button.onClick.AddListener(() =>
            {
                ...
                MissionManager.instance.CourseMissionManager.CompletedMission(this, null);
            });
        }
    }
    ...
    public override void Finished(int missionId)
    {
        if (MissionData.mission_id == missionId)
        {
            ...
            Button.onClick.AddListener(() => {
                Button.interactable = false;
                MissionManager.instance.CourseMissionManager.FinishedMission(this);
            });
            Button.interactable = false;
        }
    }
