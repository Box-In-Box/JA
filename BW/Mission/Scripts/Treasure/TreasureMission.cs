...
public class TreasureMission : MissionObserver
{
    ...
    private void Start()
    {
        ...
        var progress = MissionManager.instance.treasureMissionManager.GetProgress(missionData.mission_id);
    ...
    public override void Normal(int missionId)
    {
        ...
        {
            var progress = MissionManager.instance.treasureMissionManager.GetProgress(missionId);
