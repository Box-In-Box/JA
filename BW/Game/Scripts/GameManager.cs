...
public class GameManager : MonoPunCallbacksSingleton<GameManager>
{
    ...
    {
        // Instantiate Player
        PlayerCharacter playerCharacter = Instantiate(Resources.Load<PlayerCharacter>("PlayerCharacter")
        ...
        animator.runtimeAnimatorController = Instantiate(Resources.Load<RuntimeAnimatorController>("PlayerAnimator"));
        ...
        PlayerCameraController = Instantiate(Resources.Load<CameraController>("CameraController"));
    ...
    public GameObject CreateOtherCharacter(PhotonPlayerData photonPlayerData)
    {
        // Instantiate Player
        PlayerCharacter playerCharacter = Instantiate(Resources.Load<PlayerCharacter>("PlayerCharacter")
            , new Vector3(0f, 10000f, 0f) // 임시 하늘섬 (안보이게)
            , Quaternion.identity);
        playerCharacter.gameObject.name = $"[Player]({ photonPlayerData.uuid})";
